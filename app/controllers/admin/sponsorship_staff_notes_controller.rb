...
module Admin
  class SponsorshipStaffNotesController < Admin::ApplicationController
    before_action :set_conference
    before_action :set_staff_note, only: [:edit, :update, :destroy]
